...
async function deleteFormat(id: number) {
  try {
    loading.showLoading('Procesando solicitud...');
  ...
  <div>
    ...
    <div class="overflow-x-auto">
      <Table>
        ...
        <TableBody>
          <TableRow v-for="file in files" :key="file && typeof file === 'object' ? file.id : undefined">
            <TableCell class="font-medium">{{ file?.filetype?.name }}</TableCell>
            <TableCell>
              <Badge>{{ file?.format.split('/')[1].toUpperCase() }}</Badge>
            </TableCell>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction @click="deleteFormat(file?.id)">Eliminar</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
