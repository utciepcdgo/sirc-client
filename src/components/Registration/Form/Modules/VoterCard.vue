	...
	<Card class="w-full max-w-full border dark:border-gray-800">
		<CardHeader class="text-center">
			<CardTitle class="text-2xl font-extrabold"
				>Credencial para Votar</CardTitle
			>
		</CardHeader>
		<CardContent>
						...
						<FormItem>
							<FormLabel
								...
								<PopoverWrapper
									:message="`<img src='https://s3.us-east-1.amazonaws.com/static.appsiepcdurango.mx/Miselaneo/INE_B_CIC_OCR.png' alt='Reverso de Credencial para votar'/>`">
									<TooltipWrapper
										message="Haga clic para ver información acerca de cómo localizar el código OCR en la Credencial para Votar">
										<IconInfoCircle
											class="w-4 h-4 text-blue-400" />
									</TooltipWrapper>
								</PopoverWrapper>
					...
					<FormField v-slot="{ componentField }" name="voter_key">
						<FormItem>
							...
							<FormControl>
								<Input
									v-maska="'@@@@@@########@###'"
									placeholder="LLLLLL00000000L000"
									type="text"
									v-bind="componentField" />
							</FormControl>
							<FormMessage />
