        ...
        <div>
          <FormField v-slot="{ componentField }" name="name">
            <FormItem>
              ...
              <FormControl>
                <Input data-maska="Z-Z" data-maska-tokens="Z:[A-Z]:multiple" placeholder="Nombre(s)" type="text" v-bind="componentField"/>
              </FormControl>
              <FormMessage/>
            </FormItem>
          </FormField>
        ...
        <div>
          <FormField v-slot="{ componentField }" name="curp">
            <FormItem>
              ...
              <FormControl>
                <Input v-maska="'@@@@######@@@@@@##'" placeholder="LLLLAAMMDDHDGRLL00" type="text" v-bind="componentField"/>
              </FormControl>
              <FormMessage/>
            </FormItem>
          </FormField>
