      ...
      <Tabs class="w-full justify-center" @update:model-value="handleTabChange($event)">
        ...
        <TabsContent value="generate">
          <div class="flex flex-col text-center justify-center max-w-md mx-auto">
            ...
            <p class="text-sm">Generar el acuse de recepción se asemeja a la presentación de la documentación física ante Oficialía de Partes, por tanto, la revisión de la documentación presentada por esta vía será revisada tan pronto como sea posible. ¿Está seguro de presentar formalmente los registros?</p>
          </div>
          <p class="my-4 max-w-md mx-auto">Para presentar solicitud debe estar de acuerdo con el aviso de privacidad, mismo que puede consultar <a class="underline" href="https://www.iepcdurango.mx/IEPC_DURANGO/documentos/2021/avisos_privacidad/mod_15_feb_2021/TECNICA/FORMATO%20AVISO%20PRIVACIDAD%20REGISTRO%20DE%20CANDIDATOS.pdf" target="_blank">aquí</a>.</p>
