...
<template>
  ...
  <div class="flex flex-col min-h-screen items-center justify-center bg-gray-100 dark:bg-gray-900/50 relative">
    ...
    <Card class="w-full max-w-sm shadow-lg border dark:border-gray-800 bg-white/90 dark:bg-gray-800/90 relative z-10">
...
.animation-container {
  ...
  background-image: radial-gradient(4px 100px at 0px 235px, var(--c), #0000),
    ...
    radial-gradient(4px 100px at 0px 252px, var(--c), #0000), radial-gradient(4px 100px at 300px 252px, var(--c), #0000),
    ...
    radial-gradient(4px 100px at 0px 253px, var(--c), #0000), radial-gradient(4px 100px at 300px 253px, var(--c), #0000),
    ...
    radial-gradient(4px 100px at 0px 134px, var(--c), #0000), radial-gradient(4px 100px at 300px 134px, var(--c), #0000),
    ...
    radial-gradient(4px 100px at 0px 299px, var(--c), #0000), radial-gradient(4px 100px at 300px 299px, var(--c), #0000),
    ...
    radial-gradient(4px 100px at 0px 281px, var(--c), #0000), radial-gradient(4px 100px at 300px 281px, var(--c), #0000),
    ...
    radial-gradient(4px 100px at 0px 210px, var(--c), #0000), radial-gradient(4px 100px at 300px 210px, var(--c), #0000),
